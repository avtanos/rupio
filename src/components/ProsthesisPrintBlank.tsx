...
const ProsthesisPrintBlankComponent: React.FC<ProsthesisPrintBlankProps> = ({
  ...
  const handleComponentChange = (id: string, field: keyof ProsthesisPrintComponent, value: string | number) => {
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) => handleComponentChange(component.id, 'needsCast', e.target.value === 'Да' ? 'Да' : 'Нет')}
                            className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
                          >
