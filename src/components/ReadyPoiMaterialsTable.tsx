...
import { ReadyPoiMaterial } from '../types/readyPoiOrder';
import { Plus, Trash2 } from 'lucide-react';

interface ReadyPoiMaterialsTableProps {
  materials: ReadyPoiMaterial[];
  onMaterialsChange: (materials: ReadyPoiMaterial[]) => void;
  availableUnits: string[];
}

const ReadyPoiMaterialsTable: React.FC<ReadyPoiMaterialsTableProps> = ({
  materials,
  onMaterialsChange,
  availableUnits
}) => {
  const handleAddMaterial = () => {
    const newMaterial: ReadyPoiMaterial = {
      id: `mat_${Date.now()}`,
      articleNumber: '',
      materialName: '',
  ...
  const handleMaterialChange = (id: string, field: keyof ReadyPoiMaterial, value: string | number) => {
...
export default ReadyPoiMaterialsTable;
