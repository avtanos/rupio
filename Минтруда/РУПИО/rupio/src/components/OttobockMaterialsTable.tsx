...
import { OttobockMaterial } from '../types/ottobockOrder';
import { Plus, Trash2 } from 'lucide-react';

interface OttobockMaterialsTableProps {
  materials: OttobockMaterial[];
  onMaterialsChange: (materials: OttobockMaterial[]) => void;
  availableUnits: string[];
}

const OttobockMaterialsTable: React.FC<OttobockMaterialsTableProps> = ({
  materials,
  onMaterialsChange,
  availableUnits
}) => {
  const handleAddMaterial = () => {
    const newMaterial: OttobockMaterial = {
      id: `mat_${Date.now()}`,
      articleNumber: '',
      materialName: '',
  ...
  const handleMaterialChange = (id: string, field: keyof OttobockMaterial, value: string | number) => {
...
export default OttobockMaterialsTable;
