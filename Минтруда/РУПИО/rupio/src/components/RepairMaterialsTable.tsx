...
import { RepairMaterial } from '../types/repairOrder';
import { Plus, Trash2 } from 'lucide-react';

interface RepairMaterialsTableProps {
  materials: RepairMaterial[];
  onMaterialsChange: (materials: RepairMaterial[]) => void;
  availableUnits: string[];
}

const RepairMaterialsTable: React.FC<RepairMaterialsTableProps> = ({
  materials,
  onMaterialsChange,
  availableUnits
}) => {
  const handleAddMaterial = () => {
    const newMaterial: RepairMaterial = {
      id: `mat_${Date.now()}`,
      articleNumber: '',
      materialName: '',
  ...
  const handleMaterialChange = (id: string, field: keyof RepairMaterial, value: string | number) => {
...
export default RepairMaterialsTable;
