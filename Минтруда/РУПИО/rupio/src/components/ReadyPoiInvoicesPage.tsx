...
import ReadyPoiInvoiceForm from './ReadyPoiInvoiceForm';

interface ReadyPoiInvoicesPageProps {
  invoices: ReadyPoiInvoice[];
  personalFiles: PersonalFile[];
  orders?: Order[];
  onNewInvoice: (invoice: Omit<ReadyPoiInvoice, 'id' | 'createdAt' | 'updatedAt'>) => void;
  onUpdateInvoice: (id: string, updates: Partial<ReadyPoiInvoice>) => void;
  onDeleteInvoice: (id: string) => void;
  onPrintInvoice: (id: string) => void;
}

const ReadyPoiInvoicesPage: React.FC<ReadyPoiInvoicesPageProps> = ({
  invoices,
  personalFiles,
  orders = [],
  onNewInvoice,
  ...
  const [selectedInvoice, setSelectedInvoice] = useState<ReadyPoiInvoice | null>(null);
  const [showInvoiceForm, setShowInvoiceForm] = useState(false);
  const [editingInvoice, setEditingInvoice] = useState<ReadyPoiInvoice | null>(null);
  ...
  const handleEditInvoice = (invoice: ReadyPoiInvoice) => {
    setEditingInvoice(invoice);
    setShowInvoiceForm(true);
  };

  const handleSaveInvoice = (invoice: ReadyPoiInvoice) => {
  ...
  const handleViewInvoice = (invoice: ReadyPoiInvoice) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Накладные на готовые ПОИ</h1>
          <p className="text-gray-600">Управление накладными на готовые протезно-ортопедические изделия</p>
        </div>
        <button
              ...
              {filteredInvoices.map((invoice) => {
                ...
                return (
                  <tr key={invoice.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-900">{invoice.productCategory}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2">
                      ...
                      <div><strong>Категория:</strong> {selectedInvoice.productCategory}</div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="text-lg font-semibold mb-3">Комплектация</h3>
                    <div className="space-y-2">
...
export default ReadyPoiInvoicesPage;
