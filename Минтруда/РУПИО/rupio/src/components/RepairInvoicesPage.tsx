...
import { Plus, Search, Filter, Edit, Eye, Trash2, Printer, Download, CheckCircle, Clock, AlertCircle, Package, User, Calendar, DollarSign, FileText, Wrench } from 'lucide-react';
import { RepairInvoice, InvoiceFilters, InvoiceStats } from '../types/invoices';
import { PersonalFile } from '../types/personalFile';
import { Order } from '../types';
import RepairInvoiceForm from './RepairInvoiceForm';

interface RepairInvoicesPageProps {
  invoices: RepairInvoice[];
  personalFiles: PersonalFile[];
  orders?: Order[];
  onNewInvoice: (invoice: Omit<RepairInvoice, 'id' | 'createdAt' | 'updatedAt'>) => void;
  onUpdateInvoice: (id: string, updates: Partial<RepairInvoice>) => void;
  onDeleteInvoice: (id: string) => void;
  onPrintInvoice: (id: string) => void;
}

const RepairInvoicesPage: React.FC<RepairInvoicesPageProps> = ({
  invoices,
  personalFiles,
  orders = [],
  onNewInvoice,
  ...
  const handleEditInvoice = (invoice: RepairInvoice) => {
    setEditingInvoice(invoice);
    setShowInvoiceForm(true);
  };

  const handleSaveInvoice = (invoice: RepairInvoice) => {
  ...
  const handleViewInvoice = (invoice: RepairInvoice) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Накладные на ремонт</h1>
          <p className="text-gray-600">Управление накладными на ремонт ортопедических изделий</p>
        </div>
        <button
              ...
              {filteredInvoices.map((invoice) => {
                ...
                return (
                  <tr key={invoice.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-900">{invoice.repairType}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2">
                      ...
                      <div><strong>Тип ремонта:</strong> {selectedInvoice.repairType}</div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="text-lg font-semibold mb-3">Материалы для ремонта</h3>
                    <div className="space-y-2">
...
export default RepairInvoicesPage;
